...
<html lang="en">
  ...
  <head>
    ...
    <title>Photo Booth - Photographer Online Platform</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="photographer.php">Photographers</a>
            </li>
            <li class="nav-item">
    ...
    <div class="banner">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="caption">
              <h2>Photo Booth Photographers Online Platform</h2>
    ...
    if($result == true) {
      foreach ($result as $photographer) {
          $userID = $photographer[0];
          $fullname = $photographer["Full_Name"];
          // $categories = $photographer["cate_name"];
          $profilePicture = $photographer[5];
?>


              <a href="single-photographer.php?user_id=<?php echo $userID; ?>">
