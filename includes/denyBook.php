    ...
    try {
            ...
            if($result == true) {
                ...
                if($result == true) {
                  ...
                  $msg = "Hello Mr/Mrs ". $customer_name ." We are happly to inform that your request for Photographer has been denied on ". $event_date ." at ". $event_time ." Place will be " .$event_address ."Please find another photographer ";
