...
<div class="signup-form">
    <form action="includes/register.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="fullname" placeholder="Full Name" required="required"></div>
        ...
        <div class="form-group">
			<div class="row">
				...
				<div class="col"><input type="text" class="form-control" name="phone" placeholder="Mobile Number" required="required"></div>
			</div>        	
        </div>
		...
		<div class="form-group">
            <input type="submit" name="register" class="btn btn-success btn-lg btn-block">Register Now</button>
        </div>
